...
#find common facts effecting the grade of pieces
#length
# a = plt.figure(1)
# plt.scatter(data.Grade,data.length)
# plt.title("Grade vs Length")
# #key
# b = plt.figure(2)
# plt.scatter(data.Grade,data.key)
# plt.title("Grade vs Key")
# #number of notes
# c = plt.figure(3)
# plt.scatter(data.Grade,data.number_of_notes)
# plt.title("Grade vs Number of notes")
# #total measures
# d = plt.figure(4)
# plt.scatter(data.Grade,data.total_measures)
# plt.title("Grade vs Total Measures")
# #time signature Denominator
# e = plt.figure(5)
# plt.scatter(data.Grade,data.time_signature_den)
# plt.title("Grade vs Time Signature Den")
# #time signature Numerator
# f = plt.figure(6)
# plt.scatter(data.Grade,data.time_signature_num)
# plt.title("Grade vs Time Signature Num")
# #range
# g = plt.figure(7)
# plt.scatter(data.Grade,data.range)
# plt.title("Grade vs Range")
# a.show()
# b.show()
# c.show()
# d.show()
